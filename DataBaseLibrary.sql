...
CONSTRAINT FK_BooksAuthors FOREIGN KEY (Id_Author) REFERENCES Author(Id_Author)
);									 
																 
INSERT INTO Author(Id_Author, Name,Last_Name,Email) VALUES(50001,'Jane','Austen','j.austey@gmail.com');

INSERT INTO Author (Id_Author, Name,Last_Name,Email) VALUES(50002,'Paulo','Coelho','p.coelho@gmail.com');

INSERT INTO Author(Id_Author, Name,Last_Name,Email) VALUES(50003,'William','Goldman','w.goldman@gmail.com');

INSERT INTO Author(Id_Author, Name,Last_Name,Email) VALUES(50004,'Miguel','Cervantes','m.cervantes@gmail.com');
